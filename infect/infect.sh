...
'
echo " " 
echo -e "$red                       ▶Coded by$grn MAMBA$red◀$rset"
echo -e "$red                      ⫸$ylo  MAMBA HACKS$red ⫷$rset"
echo 
# Functions
...
then
am start -a android.intent.action.VIEW -d https://github.com/FantasticSukhi/XTeam > /dev/null 2>&1
banner
menu
elif [ $optnz = "7" ];
then
...
echo -e "\e[93m        MY WEBSITE:\e[92m https://github.com\e[0m" | pv -qL 10
...
while git clone https://github.com/FantasticSukhi/infect 2> /dev/null; do 
    printf  "\e[92m▓▓▓▓▓▓▓▓▓▓▓▓▓\e[0m"
    sleep 1
done
printf "\e[96m]\e[0m"
